 ...
 * @LastEditTime: 2021-11-07 18:50:23
 * @Description:
 * @FilePath: /commercial-paper/caliper-workspace/workload/intersects.js
 */
'use strict';

const { WorkloadModuleBase } = require('@hyperledger/caliper-core');
const { randomRadius, randomPoint, singlePolygon, randomPoints, randomLineString, randomPolygon } = require('./randomCreate');
...
class MyWorkload extends WorkloadModuleBase {
    ...
    async initializeWorkloadModule(workerIndex, totalWorkers, roundIndex, roundArguments, sutAdapter, sutContext) {
        ...
        //     const arr = randomLineString(this.roundArguments.count);
    ...
    async submitTransaction() {
        ...
        // if(tmp.features.length>100) console.log(tmp.features.length);
